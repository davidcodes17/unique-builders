...
const Project = () => {
  ...
  const gridItems = [
    // Row 1: Large, Medium
    {
      src: "/projects/IMG-20240515-WA0028.jpg",
      alt: "Modern Building Construction",
      size: "large",
      delay: 0,
    },
    {
      src: "/projects/IMG-20241130-WA0002.jpg",
    ...
    // Row 2: Medium, Large
    {
      src: "/projects/IMG-20250404-WA0038.jpg",
      alt: "Commercial Project",
      size: "medium",
      delay: 0.2,
    },
    {
      src: "/projects/IMG-20250409-WA0025.jpg",
    ...
    // Row 3: Medium, Medium
    {
      src: "/projects/IMG-20250409-WA0027.jpg",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Discover our portfolio of innovative projects that showcase our
            expertise and commitment to excellence in every detail.
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-4 md:gap-6 auto-rows-[250px] md:auto-rows-[250px] lg:auto-rows-[280px]"
        >
